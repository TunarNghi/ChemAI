            ...
            <Box display="flex" alignItems="center" gap={2}>
              ...
              <Box>
                <Box display="flex" alignItems="center" gap={1.2} flexWrap="wrap">
                  ...
                  <Chip
                    label={currentUser.className || 'Học sinh'}
                    size="small"
                    sx={{
                      bgcolor: 'rgba(56, 189, 248, 0.15)',
                      color: '#38bdf8',
                ...
                <Typography variant="caption" color="text.secondary" sx={{ fontSize: '12.5px', display: 'block', mt: 0.3 }}>
                  Trường: {currentUser.school || 'THPT'} • Tất cả thí nghiệm, trợ lý AI, đề thi và phòng thi đã mở khóa.
                </Typography>
              </Box>
            </Box>
